...
import loginPage from '../Pages/authentication.page.js';
describe('Authentication', () => {
    ...
    it('Verify User can sign up with a new email and password', () => {
        cy.origin(
            ...
            ({ }) => {
                ...
                cy.get('[type="email"]').type("testing1@yopmail.com");    //Enters a unregistered Email
    ...
    it('Verify User cannot sign up with a email already registered', () => {
        cy.origin(
            ...
            cy.get(loginPage.passwordErrorMsg).should('have.text', "We're sorry, something went wrong when attempting to sign up.");
        })
    })
    ...
    it('Verify User cannot Login with invalid password', () => {
        ...
        cy.get(loginPage.passwordErrorMsg).should('have.text', 'Wrong email or password.');
    })
